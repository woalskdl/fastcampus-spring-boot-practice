...
//		System.out.println("#####1 : " + execResult1.getStdout());
//		System.out.println("#####2 : " + execResult2.getStdout());
//		System.out.println("#####3 : " + execResult3.getStdout());
		...
		assertThat(actual3).isEqualTo(Student.of("jack", 18, Student.Grade.A));
	}
